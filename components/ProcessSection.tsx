  ...
  return (
    <section id="process" className="py-24 bg-black text-white relative">
      <div className="container mx-auto px-6">
        <div className="mb-20">
            <h2 className="text-4xl md:text-6xl font-display font-black uppercase leading-none mb-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 relative">
            ...
            {PROCESS_STEPS.map((step, index) => (
                <div key={step.id} className="relative z-10 group">
                    <div className="w-24 h-24 bg-zinc-900 border border-zinc-700 flex items-center justify-center mb-8 group-hover:border-accent group-hover:bg-accent group-hover:text-black transition-all duration-500 rounded-lg shadow-2xl relative">
